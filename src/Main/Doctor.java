...
public class Doctor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mLabel.setBackground(new java.awt.Color(51, 255, 51));
        ...
        dExitBtn.setBackground(new java.awt.Color(102, 255, 102));
        dExitBtn.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        dExitBtn.setForeground(new java.awt.Color(0, 0, 0));
        ...
        dLoginBtn.setBackground(new java.awt.Color(102, 255, 102));
        dLoginBtn.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        dLoginBtn.setForeground(new java.awt.Color(0, 0, 0));
