 ...
 */
public final class viewPatient extends javax.swing.JFrame {
    ...
    public viewPatient(String sendName) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public void loadData() {
        connection = Connector.ConnectDb();
        String sql = "select date,id,name,age,gender,address,phone,status,disease,room from patient";
        try {
    ...
    private void jLabel21MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel21MouseClicked
        doctorActivity paActivity = new doctorActivity();
