 ...
 */
public final class deleteReceptionist extends javax.swing.JFrame {
    ...
    public deleteReceptionist() {
        ...
        Object columns[] = {"Joining Date", "Id", "Name", "Age", "Gender", "Blood Group", "Email", "Phone Number", "Address", "Status"};
    ...
    public void loadData() {
        ...
        String sql = "select joining,id,name,age,gender,blood,email,phone,address,status from receptionist";
        try {
            ps = connection.prepareStatement(sql);
            rs = ps.executeQuery();
            Object columnData[] = new Object[12];
            while (rs.next()) {
                columnData[0] = rs.getString("joining");
    ...
    private void initComponents() {
        ...
        rDeletebtn.setForeground(new java.awt.Color(0, 0, 0));
