...
public class Receptionist extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rExitBtn.setBackground(new java.awt.Color(102, 255, 102));
        rExitBtn.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        rExitBtn.setForeground(new java.awt.Color(0, 0, 0));
        ...
        rLoginBtn.setBackground(new java.awt.Color(51, 255, 51));
        rLoginBtn.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        rLoginBtn.setForeground(new java.awt.Color(0, 0, 0));
